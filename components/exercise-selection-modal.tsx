import { exerciseQuery } from "@/app/(app)/(tabs)/exercises";
...
export const ExerciseSelectionModal = ({ visible, onClose }: Props) => {
	...
	const fetchExercises = async () => {
		try {
			const respondExercises = await client.fetch(exerciseQuery);
			setExercises(respondExercises);
			setFilteredExercises(respondExercises);
		} catch (error) {
